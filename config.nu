...
let is_linux: bool = (sys host | get long_os_version | str downcase | str contains "linux")
let is_wsl: bool = (sys host | get kernel_version | str downcase | str contains "microsoft")
let is_mac: bool = (sys host | get long_os_version | str downcase | str contains "macos")
